# AI-assisted Double DQN implementation; architecture, stabilization choices, and training setup directed by me.
...
class DQNAgent:
    ...
    def select_action(self, obs: dict, eval_mode: bool = False) -> int:
        ...
        Human-edited: I kept the evaluation path deterministic so final
        comparisons reflect the learned policy rather than exploration noise.
        """
    ...
    def update(self, buffer: DictReplayBuffer) -> float:
        """Sample a batch, compute Double DQN loss, step optimizer.

        NOTE: Double DQN: online net selects actions, target net evaluates them.
        I tweaked/reviewed the Double DQN target, Huber loss, gradient
        clipping, and scheduler step as the main training-stability choices.
        """
